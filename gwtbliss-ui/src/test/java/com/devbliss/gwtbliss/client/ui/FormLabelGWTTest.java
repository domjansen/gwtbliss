...
public class FormLabelGWTTest extends GWTTestCase {
    ...
    /**
     * Check that the 'for' attribute of the label matches the 'id' attribute of the referenced widget.
     */
    public void testIds() {
    ...
    public void testUniqueIds() {
        assertFalse(formLabel01.getElement().getAttribute("for").equals(formLabel02.getElement().getAttribute("for")));
        assertFalse(formLabel01.getElement().getAttribute("for").equals(formLabel03.getElement().getAttribute("for")));
        assertFalse(formLabel02.getElement().getAttribute("for").equals(formLabel03.getElement().getAttribute("for")));
    }
